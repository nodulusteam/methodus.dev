...
export class WebRequest {
  constructor(
    public auth: AuthType = AuthType.None,
              ...
              return query[element]
                .map((subelement: any) => {
                  if (typeof subelement !== "string") {
                    return `${element}=${encodeURIComponent(
  ...
  public async promiseToTry(axiosOptions: AxiosRequestConfig): Promise<any> {
    try {

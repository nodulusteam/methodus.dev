export class Mock {
    ...
    public static action(className: string, actionKey: string) {
        return {
            "base": "//localhost:8020", "methodus": {
                "_events": {}, "_descriptors": {
                    "get": {
                        "verb": "GET", "route": "/simple/get", "propertyKey": "get", "params":
                            [{ "type": "string", "from": "params", "index": 0, "name": "id" }]
                    },
                    "list": {

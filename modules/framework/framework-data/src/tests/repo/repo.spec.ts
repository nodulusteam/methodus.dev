...
import { DBHandler, ReturnType } from '../../';
...
describe('repo tests - by inheritance', () => {
    ...
    it.skip('repo find test', async () => {
       ...
       console.log(id,
        ...
        //when
        const alert: any = await Alert.find({ _id: id }, ReturnType.Single);
    ...
    it.skip('repo find test static', async () => {
        ...
        //when
        const alert = await Alert.find({ id: id }, ReturnType.Single);

        //then
        expect(alert.id.toHexString()).is.equal(id.toHexString());
    });
    ...
    it('repo updateMany', async () => {
        ...
        // when
        const res: any = await Alert.updateMany({ id: id }, { alert_title: 'zokzok_title' });

...
export class RestResponse {
    public handle(
        ...
        if (methodResult.error) {
            ...
            methodResult.result &&
            Buffer.isBuffer(methodResult.result)
        ) {
            ...
            if (typeof methodResult.result === 'string') {
                ...
                const str = stringify(
                    methodResult.result ? methodResult.result : methodResult
                );

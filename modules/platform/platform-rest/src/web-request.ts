...
export class WebRequest {
    ...
    async sendRequest(methodus: MethodusObject, uri: string, params: any[], paramsMap: RequestParams[], securityContext?: any): Promise<any> {
        ...
        const payload = handleParamsMap(paramsMap, {
            auth,
            authOptions,
            params,
            uri,
...
function handleParamsMap(paramsMap: any[], payload: RequestPayload) {
...
function handleQuery(payload: RequestPayload) {
...
function handleProxy(requestOptions: any, payload: RequestPayload) {
...
async function handleAuth(requestOptions: any, payload: RequestPayload, that: any) {
    if (payload.auth) {
        ...
        switch (payload.auth) {
            ...
            case AuthType.BearerToken:
                requestOptions.headers = requestOptions.headers || {};
                if (typeof payload.authOptions === 'function') {
                    requestOptions.headers['Authorization'] = await payload.authOptions.apply(that, [requestOptions]);
                } else {
...
function handleFiles(requestOptions: any, payload: RequestPayload) {
...
function handleHeaders(requestOptions: any, payload: RequestPayload) {

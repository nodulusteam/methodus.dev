...
[Simple Express Server](./packed/simple-express-server/readme.md)
...
[Using methodus for outbound calls](./packed/consuming-rest-services/readme.md)
> Consuming Rest services using annotated classes is pure restful joy.
***
#### Using contracts in a client application
[Frontend backed with an API](./packed/frontend-apis/readme.md)
